# AGENTS.md — Agent Instructions for VulnLab

> Auto-read by Codex agents in VSCode. Follow every rule precisely.
...
| AI Engine | Anthropic API `Codex-sonnet-4-6` + Tool Use  |
